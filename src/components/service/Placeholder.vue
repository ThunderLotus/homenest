<template>
  <div class="p-4 flex gap-4">
    <div class="flex-shrink-0 flex">
      <div class="self-center w-16 h-16 overflow-hidden rounded-2xl border border-fg/5" :class="{ 'animate-pulse': props.animate }">
    ...
    <div>
      ...
      <p class="text-sm text-fg-dimmed" :class="{ 'animate-pulse': props.animate }">
